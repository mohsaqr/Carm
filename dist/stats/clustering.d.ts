 ...
 * > fit$BIC
 */
export declare function fitGMM(data: readonly (readonly number[])[], options: GMMOptions): GMMResult;
/**
 * Predict cluster assignments for new data given a fitted GMM.
 */
export declare function predictGMM(data: readonly (readonly number[])[], result: GMMResult): {
    readonly labels: readonly number[];
    readonly posteriors: readonly (readonly number[])[];
};
/**
 ...
 */
export declare function findBestGMM(data: readonly (readonly number[])[], kRange?: readonly number[], models?: readonly CovarianceModel[]): GMMResult;
/**
 ...
 * > fit$probs
 */
export declare function fitLCA(data: readonly (readonly number[])[], options: LCAOptions): LCAResult;
/**
 ...
 */
export declare function fitLTA(data: readonly (readonly (readonly number[])[])[], options: LTAOptions): LTAResult;
/**
 ...
 */
export declare function runKMeans(data: readonly (readonly number[])[], options: KMeansOptions): KMeansResult;
/**
 ...
 */
export declare function fitGMMRange(data: readonly (readonly number[])[], kRange: readonly number[], model?: CovarianceModel): readonly GMMRangeEntry[];
/**
 ...
 */
export declare function fitKMeansRange(data: readonly (readonly number[])[], kRange: readonly number[]): readonly KMeansRangeEntry[];
export declare function predictKMeans(data: readonly (readonly number[])[], centroids: readonly (readonly number[])[]): readonly number[];
/**
 ...
 * > as.matrix(dist(data))
 */
export declare function euclideanDistMatrix(data: readonly (readonly number[])[]): Float64Array;
/**
 ...
 */
export declare function silhouetteScores(data: readonly (readonly number[])[], labels: readonly number[]): {
 ...
 */
export declare function runDBSCAN(data: readonly (readonly number[])[], options: DBSCANOptions): DBSCANResult;
/**
 ...
 */
export declare function kDistancePlot(data: readonly (readonly number[])[], k: number): readonly number[];
 ...
 */
export declare function runHierarchical(data: readonly (readonly number[])[], options?: HACOptions): HACResult;
/**
 ...
 */
export declare function cutTree(result: HACResult, k: number): readonly number[];
/**
 ...
 * > cutree(hc, h = 5.0)
 */
export declare function cutTreeHeight(result: HACResult, h: number): readonly number[];
